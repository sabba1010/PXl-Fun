...
app.post('/api/test-email', async (req, res) => {
  try {
    const mailOptions = {
      ...
      subject: 'Test Email - PXL game',
      html: '<h1>Test Email</h1><p>This is a test email from the PXL game server.</p>'
    };
...
app.post('/api/contact', async (req, res) => {
  try {
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="footer">
                <p>This is an automated email from the PXL game game server.</p>
              </div>
            </div>
          </div>
        </body>
    ...
    const mailOptions = {
      from: process.env.EMAIL_FROM,
      to: process.env.EMAIL_TO,
      subject: '🎮 New Message from PXL game Player',
      html: htmlContent,
